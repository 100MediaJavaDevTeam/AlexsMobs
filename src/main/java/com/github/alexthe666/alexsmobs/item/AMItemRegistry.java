...
public class AMItemRegistry {
    ...
    public static final Item MAGGOT = new Item(new Item.Properties().tab(AlexsMobs.TAB).food(new Food.Builder().nutrition(1).saturationMod(0.2F).build())).setRegistryName("alexsmobs:maggot");
    public static final Item BANANA = new Item(new Item.Properties().tab(AlexsMobs.TAB).food(new Food.Builder().nutrition(4).saturationMod(0.3F).build())).setRegistryName("alexsmobs:banana");
    ...
    public static final Item LOBSTER_TAIL = new Item(new Item.Properties().tab(AlexsMobs.TAB).food(new Food.Builder().nutrition(2).saturationMod(0.4F).meat().build())).setRegistryName("alexsmobs:lobster_tail");
    public static final Item COOKED_LOBSTER_TAIL = new Item(new Item.Properties().tab(AlexsMobs.TAB).food(new Food.Builder().nutrition(6).saturationMod(0.65F).meat().build())).setRegistryName("alexsmobs:cooked_lobster_tail");
    ...
    public static final Item SOPA_DE_MACACO = new SoupItem(new Item.Properties().tab(AlexsMobs.TAB).food(new Food.Builder().nutrition(5).saturationMod(0.4F).meat().build()).stacksTo(1)).setRegistryName("alexsmobs:sopa_de_macaco");
    ...
    public static final Item MOOSE_RIBS = new Item(new Item.Properties().tab(AlexsMobs.TAB).food(new Food.Builder().nutrition(3).saturationMod(0.6F).meat().build())).setRegistryName("alexsmobs:moose_ribs");
    public static final Item COOKED_MOOSE_RIBS = new Item(new Item.Properties().tab(AlexsMobs.TAB).food(new Food.Builder().nutrition(7).saturationMod(0.85F).meat().build())).setRegistryName("alexsmobs:cooked_moose_ribs");
    ...
    public static final Item BLOBFISH = new Item(new Item.Properties().tab(AlexsMobs.TAB).food(new Food.Builder().nutrition(3).saturationMod(0.4F).meat().effect(new EffectInstance(Effects.POISON, 120, 0), 1F).build())).setRegistryName("alexsmobs:blobfish");
    ...
    public static final Item FISH_OIL = new ItemFishOil(new Item.Properties().tab(AlexsMobs.TAB).craftRemainder(Items.GLASS_BOTTLE).food(new Food.Builder().nutrition(0).saturationMod(0.2F).build())).setRegistryName("alexsmobs:fish_oil");
    ...
    public static final Item SHRIMP_FRIED_RICE = new Item(new Item.Properties().tab(AlexsMobs.TAB).food(new Food.Builder().nutrition(12).saturationMod(1F).build())).setRegistryName("alexsmobs:shrimp_fried_rice");
    ...
    public static final Item BOILED_EMU_EGG = new Item(new Item.Properties().tab(AlexsMobs.TAB).food(new Food.Builder().nutrition(4).saturationMod(1F).meat().build())).setRegistryName("alexsmobs:boiled_emu_egg");
    ...
    public static final Item KANGAROO_MEAT = new Item(new Item.Properties().tab(AlexsMobs.TAB).food(new Food.Builder().nutrition(4).saturationMod(0.6F).meat().build())).setRegistryName("alexsmobs:kangaroo_meat");
    public static final Item COOKED_KANGAROO_MEAT = new Item(new Item.Properties().tab(AlexsMobs.TAB).food(new Food.Builder().nutrition(8).saturationMod(0.85F).meat().build())).setRegistryName("alexsmobs:cooked_kangaroo_meat");
    ...
    public static final Item KANGAROO_BURGER = new Item(new Item.Properties().tab(AlexsMobs.TAB).food(new Food.Builder().nutrition(12).saturationMod(1F).meat().build())).setRegistryName("alexsmobs:kangaroo_burger");
    ...
    public static final Item GONGYLIDIA = new Item(new Item.Properties().tab(AlexsMobs.TAB).food(new Food.Builder().nutrition(3).saturationMod(1.2F).build())).setRegistryName("alexsmobs:gongylidia");
    ...
    public static final Item MUSIC_DISC_THIME = new MusicDiscItem(14, AMSoundRegistry.MUSIC_DISC_THIME, new Item.Properties().tab(AlexsMobs.TAB).stacksTo(1).rarity(Rarity.RARE)).setRegistryName("alexsmobs:music_disc_thime");
    public static final Item MUSIC_DISC_DAZE = new MusicDiscItem(14, AMSoundRegistry.MUSIC_DISC_DAZE, new Item.Properties().tab(AlexsMobs.TAB).stacksTo(1).rarity(Rarity.RARE)).setRegistryName("alexsmobs:music_disc_daze");
    ...
    public static void registerItem(RegistryEvent.Register<Item> event) {
        ...
        DispenserBlock.registerBehavior(SHARK_TOOTH_ARROW, new ProjectileDispenseBehavior() {
            /**
            ...
            protected ProjectileEntity getProjectile(World worldIn, IPosition position, ItemStack stackIn) {
                ...
                entityarrow.pickup = EntitySharkToothArrow.PickupStatus.ALLOWED;
                return entityarrow;
            }
        });
        DispenserBlock.registerBehavior(ANCIENT_DART, new ProjectileDispenseBehavior() {
            protected ProjectileEntity getProjectile(World worldIn, IPosition position, ItemStack stackIn) {
        ...
        DispenserBlock.registerBehavior(COCKROACH_OOTHECA, new ProjectileDispenseBehavior() {
            protected ProjectileEntity getProjectile(World worldIn, IPosition position, ItemStack stackIn) {
                EntityCockroachEgg entityarrow = new EntityCockroachEgg(worldIn, position.x(), position.y(), position.z());
                return entityarrow;
            }
        });
        DispenserBlock.registerBehavior(EMU_EGG, new ProjectileDispenseBehavior() {
            protected ProjectileEntity getProjectile(World worldIn, IPosition position, ItemStack stackIn) {
                EntityEmuEgg entityarrow = new EntityEmuEgg(worldIn, position.x(), position.y(), position.z());
                return entityarrow;
            }
        });
        DispenserBlock.registerBehavior(ENDERIOPHAGE_ROCKET, new ProjectileDispenseBehavior() {
            protected ProjectileEntity getProjectile(World worldIn, IPosition position, ItemStack stackIn) {
