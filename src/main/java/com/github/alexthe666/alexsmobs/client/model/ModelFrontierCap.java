...
public class ModelFrontierCap extends BipedModel {
    ...
    public ModelFrontierCap withAnimations(LivingEntity entity){
        ...
        tail.xRot = 0.1956514098143546F + limbSwingAmount * (float) Math.toRadians(80) + MathHelper.cos(limbSwing * 0.3F) * 0.2F * limbSwingAmount;
        tail.yRot = -0.03909537541112055F + limbSwingAmount * (float) Math.toRadians(10) - MathHelper.cos(limbSwing * 0.4F) * 0.3F * limbSwingAmount;
