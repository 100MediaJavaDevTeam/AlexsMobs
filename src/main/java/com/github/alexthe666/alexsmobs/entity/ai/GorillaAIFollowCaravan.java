    ...
    public void tick() {
        if (this.gorilla.inCaravan() && !this.gorilla.isSitting()) {
            ...
            if (llamaentity != null) {
                ...
                Vector3d vector3d = (new Vector3d(llamaentity.getX() - this.gorilla.getX(), llamaentity.getY() - this.gorilla.getY(), llamaentity.getZ() - this.gorilla.getZ())).normalize().scale(Math.max(d0 - 2.0D, 0.0D));
