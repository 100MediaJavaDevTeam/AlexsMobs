    ...
    public void tick() {
        if (this.LeafcutterAnt.inCaravan() && !this.LeafcutterAnt.shouldLeadCaravan()) {
            ...
            if (llamaentity != null) {
                ...
                Vector3d vector3d = (new Vector3d(llamaentity.getX() - this.LeafcutterAnt.getX(), llamaentity.getY() - this.LeafcutterAnt.getY(), llamaentity.getZ() - this.LeafcutterAnt.getZ())).normalize().scale(Math.max(d0 - 2.0D, 0.0D));
