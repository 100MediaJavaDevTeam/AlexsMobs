    ...
    public void tick() {
        if (this.elephant.inCaravan() && !this.elephant.isSitting()) {
            ...
            if (llamaentity != null) {
                ...
                Vector3d vector3d = (new Vector3d(llamaentity.getX() - this.elephant.getX(), llamaentity.getY() - this.elephant.getY(), llamaentity.getZ() - this.elephant.getZ())).normalize().scale(Math.max(d0 - 4.0D, 0.0D));
